...
namespace PrivateMultipleObjects
{
    class Sport
    {
        ...
        private int _playerSalary;
        private int _coachSalary;
        public Sport()
        {
            _playerCount = 0;
            _headCoach = "";
        ...
        public virtual void updateSport()
        {
            ...
            updatePlayerCount(int.Parse(Console.ReadLine()));
            Console.Write("Player Salary: ");
            updatePlayerSalary(int.Parse(Console.ReadLine()));
            Console.Write("Head Coach: ");
            changeCoach(Console.ReadLine());
            Console.Write("Coach salary: ");
            updateCoachSalary(int.Parse(Console.ReadLine()));
        }
        public virtual void displayTeam()
        {
            Console.WriteLine("\nYour team data:");
            Console.WriteLine($"Total Player Count: {getPlayerCount()}");
            Console.WriteLine($"Player Salary: {getPlayerSalary()}");
            Console.WriteLine($"Head Coach: {getHeadCoach()}");
            Console.WriteLine($"Coach Salary: {getCoachSalary()}");
        }
    }
        // derived class
    class Baseball : Sport
    {
        ...
        public override void updateSport()
        {
            ...
            setPitcher(Console.ReadLine());
            Console.Write("mascot name: ");
            setmascot(Console.ReadLine());
        }
        public override void displayTeam()
        {
            base.displayTeam();
            Console.WriteLine($"Pitcher: {getPitcher()}");
            Console.WriteLine($"mascot: {getmascot()}");
        }
    }
    class Program
    {
